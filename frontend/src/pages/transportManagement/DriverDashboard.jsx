...
import {TruckIcon,MapIcon, ClockIcon, ChartBarIcon, BellIcon,UserIcon,ArrowTrendingUpIcon, ArrowTrendingDownIcon,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            ...
            <h1 className="ml-3 text-2xl font-bold text-gray-900">Driver Dashboard</h1>
          </div>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">Active Route</p>
              <p className="mt-2 text-3xl font-semibold text-gray-900">Route #45</p>
              <p className="mt-1 text-sm text-gray-500">3 stops remaining</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 text-3xl font-semibold text-gray-900">6.5</p>
              <p className="mt-1 text-sm text-gray-500">4.5 hours remaining</p>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Package #4567</p>
                <p className="text-xs text-gray-400 mt-1">ETA: 2:30 PM</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">456 Oak Avenue</p>
                <p className="text-sm text-gray-500">Package #4568</p>
                <p className="text-xs text-gray-400 mt-1">ETA: 3:15 PM</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">789 Pine Street</p>
                <p className="text-sm text-gray-500">Package #4569</p>
                <p className="text-xs text-gray-400 mt-1">ETA: 4:00 PM</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <div className="ml-4 flex-1">
                ...
                <p className="text-sm text-gray-500">321 Elm Street</p>
              </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4 flex-1">
                ...
                <p className="text-sm text-gray-500">New delivery added</p>
              </div>
