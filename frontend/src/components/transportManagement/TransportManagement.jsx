...
const TransportManagement = () => {
   ...
   const [isDriverVehicleModalOpen, setIsDriverVehicleModalOpen] =
      useState(false);
   ...
   const deleteVehicle = async (vehicleId) => {
      try {
         await axios.delete(
            `http://localhost:8005/api/vehicle/deletevehicle/${vehicleId}`
         );
   ...
   const handleDriverFormSubmit = async (e) => {
      ...
      try {
         await axios.post(
            "http://localhost:8005/api/vehicle/createVehicle",
            driverFormData
         );
