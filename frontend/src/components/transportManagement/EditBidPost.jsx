...
function EditBidPost({ vehicleId, setIsOpenUpdateForm, getAllData }) {
   ...
   useEffect(() => {
      axios
         .get(`http://localhost:8005/api/vehicle/getvehiclebuyid/` + vehicleId)
         .then((response) => {
   ...
   const handleSubmit = async (e) => {
      ...
      try {
         await axios.put(
            `http://localhost:8005/api/vehicle/updatevehicle/${vehicleId}`,
            driverVehicleData
         );
   ...
   return (
      <div className="bg-white p-6 rounded-lg shadow-md max-w-4xl mx-auto mt-8 relative">
         ...
         <h2 className="text-2xl font-semibold text-gray-800 mb-6">
            Edit Driver and Vehicle Details
         </h2>
