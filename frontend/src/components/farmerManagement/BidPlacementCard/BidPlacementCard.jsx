          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900">{bidplacementDetails.quantity}kg</p>
              </div>
            </div>
        ...
        { status.status == "Payment Pending" && (<div className="flex items-center justify-center  bg-gray-100">
            <div className="bg-white p-3 text-center max-w-md w-full">
              <div className='flex justify-center items-center gap-3'>
                ...
                <h2 className="text-md font-bold text-gray-800 mb-4">Bid Accepted Successfully</h2>
              </div>
