...
const MyBidsCard = ({ bid, bidId }) => {
   ...
   const generateInvoice = () => {
      ...
      doc.setFontSize(10);
      doc.text(
         "This document serves as the official bid invoice for the crops placed by the seller in the bidding platform.,",
         20,
         40
      );
      doc.text(
         "It contains the details of the crops being offered the quantity, pricing, and total cost of the bid.",
         20,
         45
      );
      ...
      <div className="relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100">
         <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-5">
               <div
                  className={`flex items-center gap-2 rounded-full px-3 py-1.5 ${statusConfig.bgColor} ${statusConfig.textColor} text-sm font-medium shadow-sm`}
               >
                  <div className="relative flex items-center">
                     ...
                     ></div>
                     <div
                        className={`w-2 h-2 rounded-full absolute top-0 left-0 animate-ping ${statusConfig.dotColor} opacity-75`}
                     ></div>
                  </div>
               ...
               <div className="flex items-center gap-2">
                  ...
                  <button className="text-blue-600 hover:text-blue-800 bg-blue-50 hover:bg-blue-100 transition-colors p-2 rounded-lg font-medium text-sm flex items-center">
                     <MessageSquare size={16} />
                  </button>
               </div>
            </div>
               ...
               <div className="flex-1">
                  <div className="bg-white">
                     ...
                     <div className="flex items-start mb-4">
                        <Leaf
                           className="mr-3 mt-1 text-green-500 flex-shrink-0"
                           size={16}
                        />
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-3">
                     <div className="bg-gray-50 rounded-lg p-4 border border-gray-100">
                        <span className="text-xs uppercase tracking-wider text-gray-500 block mb-1 font-medium">
                           Starting Price
                        </span>
